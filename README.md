...
Generates alt text for all images in the collection. If grounding examples and style guide have been created, they are sent as part of the prompt, and applied to every image.
...
**Recommended: start with a grounding run**
...
**Or skip grounding and run directly:**
